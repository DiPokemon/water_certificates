	...
	<table class="wp-list-table widefat fixed striped posts">
		...
		<?php
			...
			<tr>
				...
				<td><?= $item->alt ?></td>
				<td>
					<a href="<?= WATER_CERTIFICATES_PLUGIN_ADMIN_URL . '&view=edit&data_id=' . $item->id ?>">Редактировать</a>
					|
					<a href="<?= WATER_CERTIFICATES_PLUGIN_ADMIN_URL . '&action=delete&data_id=' . $item->id ?>">Удалить</a>
				</td>
			</tr>
		<?php endforeach ?>
